...
public class Camara : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        transform.position = UnityEngine.Vector3.Lerp(transform.position, new UnityEngine.Vector3(posX, posY, -1), 1); 
    ...
    void Move_Cam()
    {
        if (encendida)
        {
            ...
            transform.position = UnityEngine.Vector3.Lerp(transform.position, new UnityEngine.Vector3(posX, posY, -1), speed*Time.deltaTime); 
        }
    }
